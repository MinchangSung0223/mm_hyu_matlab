...
plot3([0 p(1,1) p(1,2) p(1,3) p(1,4) p(1,5) p(1,6)],...
    [0 p(2,1) p(2,2) p(2,3) p(2,4) p(2,5) p(2,6)],...
    [0 p(3,1) p(3,2) p(3,3) p(3,4) p(3,5) p(3,6)],'k.');
...
if show_mesh==1
    color_ = [0.5 0.5 0.5];
        patch(fv{1},'FaceColor',      color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);
        patch(stl_T(T_list{1},fv{2}),'FaceColor',      color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);
        patch(stl_T(T_list{2},fv{3}),'FaceColor',       color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);
        patch(stl_T(T_list{3},fv{4}),'FaceColor',      color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);
        patch(stl_T(T_list{4},fv{5}),'FaceColor',       color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);
        patch(stl_T(T_list{5},fv{6}),'FaceColor',       color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);
        patch(stl_T(T_list{6},fv{7}),'FaceColor',       color_, ...
             'EdgeColor',       'none',        ...
             'FaceLighting',    'gouraud',     ...
             'AmbientStrength', 0.15);         
         camlight('headlight');  
